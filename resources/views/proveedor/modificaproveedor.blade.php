            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        <form action="{{Route('guardaedicionpro')}}" method='POST' enctype='multipart/form-data' align="center">
                            {{csrf_field()}}
                            <h1 align='center'> Modifica Proveedor</h1>
                            <br>
                            <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" id="id" type='text' name='id_prov' value="{{$proveedores->id_prov}}"
                                        readonly='readonly'>
                                </div>
                            </div>
                            ...
                            <i> {{ $errors->first('nombre_prov') }}<i>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="Nombre" type='text' name='nombre_prov'
                                                value="{{$proveedores->nombre_prov}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="Apellido Paterno" type='text' name='apa_prov'
                                                value="{{$proveedores->apa_prov}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="Apellido Materno" type='text' name='ama_prov'
                                                value="{{$proveedores->ama_prov}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="{{asset('Archivo/'. $proveedores->archivo)}}" height=150 windth=150>
                                    ...
                                    <i> {{ $errors->first('correo_prov') }}<i>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" id="Correo" type='text' name='correo_prov'
                                                        value="{{$proveedores->correo_prov}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" id="Telefono" type='text' name='tel_prov'
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for=" Telefono"> Genero<span
                                                        class="text-danger">*</span></label>
                                                @if($proveedores->genero=='masculino')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" id="Calle" type='text' name='calle_prov' value="{{$proveedores->calle_prov}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" id="Numero Exterior" type='text' name='no_ext' value="{{$proveedores->no_ext}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" id="Numero Interior" type='text' name='no_int' value="{{$proveedores->no_int}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" id="Colonia" type='text' name='col_prov' value="{{$proveedores->col_prov}}">
                        </div>
                    </div>
                    ...
                    @endif
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label" for="Localidad"> Localidad:<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input class="form-control" id="Localidad" type='text' name='loca_prov' value="{{$proveedores->loca_prov}}">
                        </div>
                    </div>
                    ...
                    <i> {{ $errors->first('cp') }}<i>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" id="Codigo Postal" type='text' name='cp' value="{{$proveedores->cp}}">
                                </div>
                            </div>
