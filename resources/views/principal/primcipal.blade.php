...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="public/nuevos/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="public/nuevos/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Acerca de</a>
            </li>
            <li class="nav-item">
 ...
 <section id="contact">
  ...
  <!-- Registros del nuevo usuario -->
    <section class="bg-light" id="registro">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h2 class="section-heading text-uppercase">Registrate Aqui!</h2>
            </div>
          </div>
              </div>
            </div>
          <div class="row">
            <div class="col-lg-8 mx-auto text-center">
              <p class="large text-muted">Aqui podras realiza tu registro como cliente o proveedor.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <section class="py-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="img/logos/sondellogo.png" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="img/logos/axalta.jpg" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="img/logos/Telmex.png" alt="">
            </a>
          </div>
        </div>
      </div>
 ...
 <section id="sesion">
    ...
    <script src="public/nuevos/vendor/jquery/jquery.min.js"></script>
    <script src="public/nuevos/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="public/nuevos/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Contact form JavaScript -->
    <script src="public/nuevos/js/jqBootstrapValidation.js"></script>
    <script src="public/nuevos/js/contact_me.js"></script>

    <!-- Custom scripts for this template -->
    <script src="public/nuevos/js/agency.min.js"></script>
