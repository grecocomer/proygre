                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                ...
                                <li><a href="#"><i class="ti-user"></i> ID User {{Session::get('sesionidu')}}</a></li>
                                <li><a href="#"><i class="ti-user"></i> {{Session::get('sesionname')}}</a></li>
                                  <!--  <li><a href="#"><i class="ti-user"></i> Profile</a></li>
                                    <li><a href="#"><i class="ti-wallet"></i> Balance</a></li>
                                    <li><a href="#"><i class="ti-email"></i> Inbox</a></li>
                                    <li><a href="#"><i class="ti-settings"></i> Setting</a></li>-->
                                    <li><a href="{{URL::action('conuser@cerrarsesion')}}"><i class="fa fa-power-off"></i> Logout</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-label">Altas</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Formularios</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="altacliente">Cliente</a></li>
                                <li><a href="altaempleados">Empleado</a></li>
                                <li><a href="altaproveedor">Proveedor</a></li>
                                <li><a href="altaservicio">Servicio</a></li>
                                <li><a href="altaproducto">Producto</a></li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Ventas</span></a>
                            <ul aria-expanded="false" class="collapse">
                              ...
                              <li><a href="buscador">Reportes</a></li>
                            </ul>
                        </li>
