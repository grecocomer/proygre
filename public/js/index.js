...
var v1 = function () {
    ...
    if ($("#world-map").length) {
        ...
        $("#world-map").vectorMap({
            ...
            hoverOpacity     : .5,
            hoverColor       : false,
            markerStyle      : {initial: {fill: "#FFA534", stroke: "transparent", r: 3}},
            regionStyle      : {
                initial : {
    ...
    if ($(".add_shadow").length !== 0) {
        $(".add_shadow").realshadow({followMouse: false, type: 'drop'});
    }
    ...
    $(function () {
        $(".mega_menu_new_click").on("click", function () {
            dialog.close();
            setTimeout(function () {
                $(".dropdown.dropdown-lg").addClass("open")
            }, 200);
        })
    })
};
